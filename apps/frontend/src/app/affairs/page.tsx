...
export default function AffairsLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to affairs dashboard
      router.push("/affairs/dashboard");
    } catch (err: unknown) {
      ...
      <div className="w-full max-w-sm p-4 rounded-xl">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input
              id="email"
              type="email"
              placeholder="affairs@schoolptk.ac.th"
              className="bg-white"
        ...
        <div className="mt-6 pt-6">
          <p className="text-xs text-center text-gray-500">
            For authorized staff only • ฝ่ายปกครองเท่านั้น
          </p>
        </div>
